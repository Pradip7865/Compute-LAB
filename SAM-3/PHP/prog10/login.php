                ...
                try {
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        if ($username == $userdata['email'] && $password == $userdata['password']){
                            ...
                            <a href="index.php" class="goTo" id="failedTxt" style="font-size: 24px;text-transform: uppercase;padding: 0.5rem 1rem;border-radius: 6px;color: #EBF0F5;background-color: #FF1A1A;border=none;">Go Back</a>';
                        }
                    }
