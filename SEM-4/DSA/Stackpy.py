...
print("Deleting 2 from the arary")
arrOps.delete(2)

# Search for value 2
print("Searching the 2 position and showing it")
print(arrOps.search(2))

# Update value at index 3 to be 8
print("Updating the 3rd index value to 8")
arrOps.update(3, 8)
